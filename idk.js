(function () {
    ...
    root.Tick.push([
      ...
      (function () {
        ...
        var index = function (_ref) {
          ...
          var easeOutCubic = Extension.getExtension(
            Extension.Type.EASING_FUNCTION,
            "ease-out-cubic"
          );
          var easeOutSine = Extension.getExtension(
            Extension.Type.EASING_FUNCTION,
            "ease-out-sine"
          );
          ...
          var draw = function draw(state) {
            ...
            if (!state.animating) {
              ...
              var ease = Extension.getExtension(
                Extension.Type.EASING_FUNCTION,
              ...
              var tick = function tick() {
                ...
                cardsToAnimate.reverse().forEach(function (card, index) {
                  ...
                  if (
                    ...
                    card.visual_progress =
                      previousCard.visual_progress + cardDistance;
                  }
                });
                ...
                state.cards.forEach(function (card, index) {
                  ...
                  var shadowFrontProgress =
                    1 - Math.abs(card.visual_progress - 0.5) * 2;
                  var highlightBackProgress =
                    1 - (card.visual_progress - 0.5) / 0.5;
          ...
          var FlipCard = (function () {
            function FlipCard() {
              ...
              var textBackWrapper = DOM.create(
                "span",
                "tick-flip-panel-text-wrapper"
              );
              textBack.appendChild(textBackWrapper);
              var highlightBack = DOM.create(
                "span",
  ...
  (function (root, plugins, undefined) {
    ...
    if (
      !root ||
      !("MutationObserver" in root) ||
      !("requestAnimationFrame" in root)
    ) {
      return;
    }
    ...
    var Tick = (function () {
      ...
      var serverDate = function serverDate(cb) {
        ...
        xhr.onload = function () {
          var correction = (now - Date.now()) * 0.5;
   ...
   */
      ...
      var timeDuration = function timeDuration(milliseconds, components) {
        return components.map(function (key) {
          ...
          var count = Math.max(
            0,
            Math.floor(milliseconds / requiredMilliseconds)
          );
      ...
      var dateDiff = function dateDiff(a, b, components) {
        ...
        if (
          mIndex >= 0 &&
          (components[mIndex - 1] === "y" || components[mIndex + 1] === "d")
        ) {
        ...
        if (presentsMonths || presentsYears) {
          ...
          months = presentsMonths
            ? Math.floor(monthsRemaining)
            : Math.floor(monthsRemaining / 12) * 12;
        ...
        var output = components.map(function (key) {
          ...
          if (key === "y" || key === "M") {
            var _count = Math.max(
              0,
              Math.floor(monthsRemaining / MonthFactor[key])
            );
      ...
      var rooter = function (state) {
        ...
        if (root && root.dataset.layout) {
          state.align =
            (root.dataset.layout.match(/left|right|center/) || [])[0] || "left";
        }
          ...
          appendTo: function appendTo(element) {
            ...
            if (location === "last") {
              ...
              if (
                ...
                element.childNodes[element.childNodes.length - 1].nodeType ===
                  Node.TEXT_NODE
              ) {
      ...
      var fit = function fit(state) {
        if (!state.fit) {
          ...
          if (
            !state.root ||
            !(state.root.getAttribute("data-layout") || "").match(/fit/)
          ) {
            state.fit = false;
            return;
          }
      ...
      var draw = function draw(state, present) {
        ...
        var value = Array.isArray(state.value)
          ? state.value.concat()
          : _typeof(state.value) === "object"
          ? clone(state.value)
          : state.value;
      ...
      var draw$1 = function draw(state, present, ready) {
        ...
        var value = copyArray(
          Array.isArray(state.value) ? state.value : (state.value + "").split("")
        );
        ...
        value.forEach(function (value, index) {
          ...
          if (!def) {
            ...
            def.presenter.appendTo(
              state.root,
              state.align === "right" ? "first" : "last"
            );
          }
        });
      ...
      var observeAttributes = function observeAttributes(
        element,
        attributes,
        cb
      ) {
      ...
      var easeOutElastic = function easeOutElastic(t) {
        var magnitude =
          arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.7;
      ...
      var createTransition = function createTransition(name, parameters, ease) {
        var easing = ease
          ? getExtension(ExtensionType.EASING_FUNCTION, ease)
          : ease;
        var transition = getExtension(ExtensionType.TRANSITION, name);
        return function (element, direction, p) {
          transition.apply(
            undefined,
            [element, p, direction, easing].concat(toConsumableArray(parameters))
          );
        };
      };
  
      var createDurationTransitioner = function createDurationTransitioner(
        transition
      ) {
        var origin =
          arguments.length > 1 && arguments[1] !== undefined
      ...
      var getComposedTransitionActs = function getComposedTransitionActs(
        transition
      ) {
        return getExtension(ExtensionType.TRANSITION, transition.name).apply(
          undefined,
          toConsumableArray(transition.parameters || [])
        );
      };
      ...
      var styler = function (state) {
        ...
        state.styleObserver = observeAttributes(
          state.root,
          ["data-style"],
          function (string) {
      ...
      var updateStyles = function updateStyles(state, base, css) {
        ...
        if (intro && outro) {
          ...
          state.skipToTransitionInEnd = createTransitioner(
            intro.map(clearTiming)
          );
          state.skipToTransitionOutEnd = createTransitioner(
            outro.map(clearTiming)
          );
        }
      ...
      var getBackingStoreRatio = function getBackingStoreRatio(ctx) {
        return (
          ctx[VENDOR_PREFIX + "BackingStorePixelRatio"] ||
       ...
       */
      var createPresenterRoot = function createPresenterRoot(
        root,
        definition,
        presentDefinition
      ) {
      ...
      var createPresenterRepeater = function createPresenterRepeater(
        root,
        definition,
        presentDefinition
      ) {
        ...
        for (var key in definition) {
          ...
          if (key === "children") {
            clone[key] =
              definition[key] === null
                ? null
                : definition[key].map(cloneDefinition);
            continue;
          }
  
          if (key === "repeat") {
            clone[key] =
              definition[key] === null ? null : cloneDefinition(definition[key]);
            continue;
          }
          ...
          Array.from(nodes)
            ...
            .map(function (node) {
              ...
              if (definition.repeat) {
                ...
                definition.repeat = toPresenterDefinitionTree(
                  node.children
                ).pop();
      ...
      var createDOMTreeForDefinition = function createDOMTreeForDefinition(
        definition
      ) {
       ...
       * Presenting values
       */
      var createPresenterByDefinition = function createPresenterByDefinition(
        definition,
        presentDefinition
      ) {
        ...
        if (definition.repeat) {
          presenter = createPresenterRepeater(
            definition.root,
            definition.repeat,
            presentDefinition
          );
        } else if (typeof definition.view === "string") {
          presenter = createPresenterView(
            definition.view,
            definition.root,
            definition.style
          );
        } else if (isRootDefinition(definition)) {
          presenter = createPresenterRoot(
            definition.root,
            definition.children,
            presentDefinition
          );
      ...
      var presentTick = function presentTick(instance) {
        ...
        var presentDefinition = function presentDefinition(definition) {
          definition.presenter = createPresenterByDefinition(
            definition,
            presentDefinition
          );
          definition.transform = toTransformComposition(
            definition.transform,
            instance
          );
          return update;
      ...
      var toTransformComposition = function toTransformComposition(
        string,
        instance
      ) {
        // no composition
        ...
        var result = parseTransformChain(
          "transform(" + (/^[a-z]+$/.test(string) ? string + "()" : string) + ")"
        );
      ...
      var compose = function compose(chain, instance) {
        var composition = chain.map(function (item) {
          ...
          var func =
            getExtension(ExtensionType.TRANSFORM, name) ||
            function (value, cb, instance) {
              cb(value);
            };
        ...
        return composeAsync.apply(
          undefined,
          [instance].concat(toConsumableArray(composition))
        );
      };
   ...
   */
          ...
          [
            ...
            },
            {
              ...
              value: function _init() {
                ...
                this._observer = observeAttributes(
                  this._element,
                  ["data-value"],
                  function (value) {
                    _this.value = value;
      ...
      var transformDurationUnit = function transformDurationUnit(
        value,
        single,
        plural,
        progress
      ...
      var setTimer = function setTimer(cb) {
        ...
        var tick = function tick() {
          ...
          var runtime =
            currentTime - tickStartTime - totalSleepTime + timeoutErrorOffset;
        ...
        var stopListeningForVisibilityChanges =
          function stopListeningForVisibilityChanges() {
        ...
        var startListeningForVisibilityChanges =
          function startListeningForVisibilityChanges() {
    ...
    */
      ...
      var countdownAmount = function countdownAmount(total) {
        ...
        options = mergeObjects(
          { units: "seconds", target: 0, amount: 1000, interval: 1000 },
          options
        );
      ...
      var countScheduled = function countScheduled(schedule) {
        ...
        options = mergeObjects(
          _extends({}, DEFAULT_COUNTDOWN_OPTIONS, { timezone: null }),
          options
        );
  
        // get timezone offset
        var timezone = options.timezone
          ? toTimezoneOffset(options.timezone)
          : null;
          ...
          var count = function count() {
            ...
            if (counter.waiting) {
              ...
              if (counter.nextScheduledDate) {
                counter.previouslyScheduledDate = clone$1(
                  counter.nextScheduledDate
                );
              }
  
              // update counter dates
              counter.nextScheduledDate =
                nextDate === null ? null : clone$1(nextDate);
  
              // update counter
              counter.onwait(
                counter.previouslyScheduledDate
                  ? clone$1(counter.previouslyScheduledDate)
                  : null
              );
            ...
            if (
              lastDate === null ||
              (lastDate !== undefined && !sameTime(lastDate, nextDate))
            ) {
              counter.onrepeat(
                clone$1(nextDate),
                lastDate ? clone$1(lastDate) : null
              );
      ...
      var support = function () {
        ...
        var canTransform =
          canSupport && CSS.supports("transform", "translateX(0)");
      ...
      var transform = function () {
        for (
          var _len = arguments.length, transforms = Array(_len), _key = 0;
          _key < _len;
          _key++
        ) {
          ...
          return cb(
            padding.length > ("" + value).length
              ? side === "left"
                ...
                : ("" + value + padding).substring(0, padding.length)
              : value
          );
        };
      };
      ...
      var replace = function (needle, replacement) {
        return function (string, cb) {
          return cb(
            (string + "").replace(
              new RegExp(needle === "." ? "\\" + needle : needle, "g"),
              replacement
            )
          );
        };
      ...
      var delay = function () {
        ...
        return function (value, cb) {
          ...
          current =
            order === "rtl"
              ? current.slice(current.length - value.length, current.length)
              : current.slice(0, value.length);
      ...
      var duration$1 = function () {
        for (
          var _len = arguments.length, format = Array(_len), _key = 0;
          _key < _len;
          _key++
        ) {
      ...
      var preset = function () {
        for (
          var _len = arguments.length, presets = Array(_len), _key = 0;
          _key < _len;
          _key++
        ) {
        ...
        return function (value, cb, instance) {
          return cb(
            value.map(function (v, index) {
              return instance.getPreset(presets[index])(
                v,
                instance.getConstants(),
                instance
              );
            })
          );
      ...
      var swap = function () {
        var axis =
          arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "y";
        var distance =
          arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
        var speed =
      ...
      var move = function move(element, p, direction) {
        ...
        var to =
          arguments.length > 5 && arguments[5] !== undefined
            ...
            : "100%";
        var axis =
          arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : "y";
      ...
      var rotate$1 = function rotate(element, p, direction) {
        ...
        var to =
          arguments.length > 5 && arguments[5] !== undefined
            ...
            : "90deg";
        var axis =
          arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : "x";
      ...
      var _loop = function _loop(type) {
        ...
        API.plugin[dashesToCamels("add-" + ExtensionType[type])] = function (
          name,
          fn
        ) {
